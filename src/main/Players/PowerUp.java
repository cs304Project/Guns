...
public class PowerUp {
    ...
    GL gl;
    public Collision c = new Collision(xPresent,yPresent,0.09f);
    public PowerUp(GL gl, float xPresent, float yPresent, float spead, boolean hitted) {
        this.gl = gl;
    ...
    public void movePresent() {
        ...
        //check for the power score and increase bullets (or in player class)
        //if collesion happend decrease powerscore 
    }
}
